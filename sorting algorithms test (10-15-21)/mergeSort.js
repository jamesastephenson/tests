// Merge Sort
    // uses a divide and conquer technique, it breaks the array into subarrays of size 1 and merges them
    // split array elements into individual elements
    // compare the individual elements and arrange them in order
        // this results in subarrays of lengths 1 or 2
    // make an empty array
...
// merging two arays appropriately
function merge(arr1, arr2) {
    // make new array nad have two value pointers
    let res = [];
    i = 0;
    j = 0;
...
function mergeSort(arr) {
    ...
    let mid = Math.ceil(arr.length / 2);  // ceil rounds up to next largest int
    ...
    for (i = 0; i < arr1_subarrays.length; i += 2) {
    ...
    for (i = 0; i < arr2_subarrays.length; i += 2) {
